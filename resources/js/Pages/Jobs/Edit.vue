<template>
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form @submit.prevent="editJob" enctype="multipart/form-data">
...
const form = useForm({
    ...
    company_description: props.job.company_description,
    company_logo: null,
    company_website: props.job.company_website,
});

const editJob = () => form.put(route("jobs.update", props.job.id));
</script>
